...
public class KotlinParserBaseListener implements KotlinParserListener {
    ...
    @Override
    public void enterGenericCallLikeComparison(KotlinParser.GenericCallLikeComparisonContext ctx) {

    }

    @Override
    public void exitGenericCallLikeComparison(KotlinParser.GenericCallLikeComparisonContext ctx) {
