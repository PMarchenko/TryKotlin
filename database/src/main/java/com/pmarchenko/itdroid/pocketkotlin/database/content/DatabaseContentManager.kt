package com.pmarchenko.itdroid.pocketkotlin.database.content
...
import com.pmarchenko.itdroid.pocketkotlin.database.entity.ProjectType
import java.io.InputStreamReader
import com.pmarchenko.itdroid.pocketkotlin.database.entity.Example as DBExample
import com.pmarchenko.itdroid.pocketkotlin.database.entity.Project as DBProject
import com.pmarchenko.itdroid.pocketkotlin.database.entity.ProjectFile as DBFile
...
internal class DatabaseContentManager(private val context: Context) {
    ...
    private suspend fun fillExamples(dao: ProjectDao) {
        ...
        dao.insert(examples.map(Example::dbEntity))
    }
