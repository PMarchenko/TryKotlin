...
class ErrorSpan(start: Int, end: Int) : SyntaxTokenHolder(ColorUnderlineSpan(Color.parseColor("#BBEC5424")), start, end)

class WarningSpan(start: Int, end: Int) : SyntaxTokenHolder(ColorUnderlineSpan(Color.parseColor("#BBFFC107")), start, end)
...
class TestHighlight(start: Int, end: Int) : SyntaxTokenHolder(ColorUnderlineSpan(Color.parseColor("#BBAAAAAA")), start, end)