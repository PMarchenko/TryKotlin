    ...
    private static class TabLayoutOnPageChangeCallback extends ViewPager2.OnPageChangeCallback {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            if (tabLayout != null) {
                ...
                // being dragged
                boolean updateText = mScrollState != RecyclerView.SCROLL_STATE_SETTLING
                        || mPreviousScrollState == RecyclerView.SCROLL_STATE_DRAGGING;
                // Update the indicator if we're not settling after being idle. This is caused
                // from a setCurrentItem() call and will be handled by an animation from
                // onPageSelected() instead.
                boolean updateIndicator = !(mScrollState == RecyclerView.SCROLL_STATE_SETTLING
        ...
        public void onPageSelected(final int position) {
            ...
            if (tabLayout != null
                ...
                boolean updateIndicator = mScrollState == RecyclerView.SCROLL_STATE_IDLE
        ...
        void reset() {
            mPreviousScrollState = mScrollState = RecyclerView.SCROLL_STATE_IDLE;
        }
    }
